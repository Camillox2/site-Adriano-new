export const CITIES = {
  ...
  'francisco-beltrao': {
    ...
    state: 'PR',
    slugSuffix: 'francisco-beltrao',
    isPrimary: false,
    locationTitle: 'para pacientes de Francisco Beltrão - PR',
    contextText: 'odontologia de excelência para pacientes de Francisco Beltrão - PR, com fácil acesso ao consultório em São Lourenço do Oeste - SC.',
  },
  'dois-vizinhos': {
    name: 'Dois Vizinhos',
    state: 'PR',
    slugSuffix: 'dois-vizinhos',
    isPrimary: false,
    locationTitle: 'para pacientes de Dois Vizinhos - PR',
    contextText: 'estrutura completa e tratamentos avançados para pacientes de Dois Vizinhos - PR no consultório do Dr. Adriano Camillo.',
  },
  'palmas': {
    name: 'Palmas',
    state: 'PR',
    slugSuffix: 'palmas',
    isPrimary: false,
    locationTitle: 'para pacientes de Palmas - PR',
    contextText: 'atendimento odontológico premium e acolhedor para moradores de Palmas - PR em nosso consultório em São Lourenço do Oeste.',
  },
  'xanxere': {
    name: 'Xanxerê',
    state: 'SC',
    slugSuffix: 'xanxere',
    isPrimary: false,
    locationTitle: 'para pacientes de Xanxerê - SC',
    contextText: 'referência em odontologia moderna para pacientes de Xanxerê - SC que buscam resultados seguros e naturais.',
  },
  'maravilha': {
    name: 'Maravilha',
    state: 'SC',
    slugSuffix: 'maravilha',
    isPrimary: false,
    locationTitle: 'para pacientes de Maravilha - SC',
    contextText: 'planejamento digital e tecnologia de ponta disponíveis para pacientes de Maravilha - SC no consultório em São Lourenço do Oeste.',
  },
  'pinhalzinho': {
    name: 'Pinhalzinho',
    state: 'SC',
    slugSuffix: 'pinhalzinho',
    isPrimary: false,
